...
export default class TextField extends Component {
  ...
  focus() {
      this.props.plusMask?this.refs.input.refs['$input-text'].focus():this.refs.input.focus();
  }
  blur() {
      this.props.plusMask?this.refs.input.refs['$input-text'].blur():this.refs.input.blur();
  }
  isFocused() {
  ...
  componentWillReceiveProps(nextProps: Object){
    ...
    if(nextProps.hightlightColor!==this.props.highlightColor){
          this.setState({hightlightColor:nextProps.hightlightColor})
    }
    if(nextProps.error){
  ...
  render() {
    ...
    return (
      <View style={[dense ? styles.denseWrapper : styles.wrapper, wrapperStyle]} ref="wrapper">
        ...
        <Underline
          ref="underline"
          highlightColor={this.state.hightlightColor||highlightColor}
          duration={duration}
